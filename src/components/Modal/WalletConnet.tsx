...
const WalletConnet = (props: { isModalVisible: boolean, handleOk: () => void, handleCancel: () => void }) => {
  ...
  return (
    <Modal visible={props.isModalVisible} onOk={props.handleOk} onCancel={props.handleCancel} footer={null} className='wallet-modal'>
