    ...
    <>
        ...
        <div tw="ml-5">
          ...
          <div tw="flex">
            <div tw="flex items-center">
              ...
              <div tw="text-blue-100 text-sm w-[100px]" className="txt-overflow">{nft.title}</div>  
            </div>
            <div tw="text-gray-50 px-2">·</div>
            <div tw="flex items-center">
              <div tw="text-gray-50 text-sm">Created by:</div>
              <img alt="metamask" src={img2} tw="w-3 h-3 mx-1"/>
              <a tw="text-blue-100 text-sm mx-1.5 cursor-pointer w-[77px]" className="txt-overflow" target="_blank" href={`https://rinkeby.etherscan.io/address/${nft?.creatorAddress}`}>{nft?.creator?.name?nft?.creator?.name:addressFormat(nft?.creatorAddress)}</a>  
            </div>
            <div tw="text-gray-50 px-2">·</div>
            <div tw="flex items-center">
              <div tw="text-gray-50 text-sm">Owned by:</div>
              {/* <img alt="metamask" src={img2} tw="w-3 h-3 mx-1.5"/> */}
              <a tw="text-blue-100 pr-1.5 text-sm mx-1.5 cursor-pointer w-[77px]" className="txt-overflow" target="_blank" href={`https://rinkeby.etherscan.io/address/${nft?.owneraccount}`}>{nft?.owner?.name?nft?.owner?.name:addressFormat(nft?.owneraccount)}</a>  
            </div>
          </div>
        </div>            
      </div>
      ...
      <div tw="md:hidden">
        ...
        <div tw="flex justify-around mt-6">
          <div tw="">
            <div tw="text-gray-50 text-sm mb-1 text-center sm:text-left">Collection:</div>
            <div tw="flex items-center justify-center">
          ...
          <div tw="">
            <div tw="text-gray-50 text-sm mx-auto mb-1 text-center sm:text-left">Created by:</div>
            <div tw="flex items-center justify-center">
          ...
          <div tw="">
            <div tw="text-gray-50 text-sm mb-1 text-center sm:text-left">Owned by:</div>
            {/* <img alt="metamask" src={img2} tw="w-3 h-3 mx-1.5"/> */}
