...
const Profile = () => {
  ...
  return (
    <StyledPage>
      <div tw="w-full sm:mx-auto sm:max-w-6xl px-3 pt-14 pb-32">
        <div tw="text-3xl text-gray-300 font-bold px-4">Edit profile</div>
        <div tw="flex sm:flex-row flex-col-reverse px-4">
          <div tw="mt-12 flex-1">
            <div>
            ...
            <div tw="mt-6">
              ...
              <div tw="grid grid-cols-5 gap-2">
                ...
                <button tw="col-span-1 bg-white text-violet-200 text-[13px] font-semibold  py-1 rounded border border-solid border-violet-200  hover:border-violet-100">
                  Link
                </button>
              </div>
            </div>
          ...
          <div tw="sm:px-10 flex-1">
            <div tw="text-base font-semibold text-gray-300 mb-2 mt-12">Profile picture</div>
            <div tw='flex items-center sm:items-start sm:flex-col'>
              <img alt="metamask" src={newImage} tw="w-28 sm:w-32 rounded-full mt-5"/>
              <div tw='ml-3 sm:ml-0'>
                <div tw="text-xs text-gray-800 sm:mt-6">Recommended an image of at<br></br> least 350 x 350. Max size: 50mb</div>
                <ImageUploader
                  withLabel={false}
                  withIcon={false}
                  buttonStyles={{
